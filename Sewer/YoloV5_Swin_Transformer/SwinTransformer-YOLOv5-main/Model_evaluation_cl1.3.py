...
model = torch.hub.load(r'D:\Desktop\YoloV5_T\SwinTransformer-YOLOv5-main', 'custom',
                       path=r'D:\Desktop\YoloV5_T\SwinTransformer-YOLOv5-main\yolo_test\base_n3\weights\best.pt', source='local')
l1 = ModelEvaluation(model, r'D:\Desktop\YoloV5_T\val', 'yl', ['AJ', 'BX', 'CJ', 'CK', 'CQ', 'FS', 'FZ', 'JG_Down', 'QF', 'SG',
                     'SL', 'TL', 'ZW'], 0.5)
