...
if __name__ == "__main__":
    ...
    ap.add_argument("-d", "--data_root", default ="./Data")
    ap.add_argument("-a", "--ann_root", default ="./annotations")
    ap.add_argument("-o", "--output_dir", help="Path to where the output ground truth CSV file should be saved", default ="./GistFeatures")
    ap.add_argument("-co", "--cores", help="Amount of CPU cores to use", default = 8, type = int)
