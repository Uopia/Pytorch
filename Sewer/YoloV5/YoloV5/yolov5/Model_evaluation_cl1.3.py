...
class ModelEvaluation:
    ...
    def __init__(self, model, folder, model_name, use_name, cf):
        ...
        self.labels_list = ['AJ', 'BX', 'CJ', 'CK', 'CQ', 'CR', 'FS', 'FZ', 'JG_D', 'PL', 'QF', 'SG',
                            'SL', 'TL', 'ZW', 'JG_U', 'PL_L']
        self.folder = folder
...
model = torch.hub.load(r'D:\Desktop\YoloV5\yolov5', 'custom',
                       path=r'D:\Desktop\YoloV5\yolov5\yolo_1027\best.pt', source='local')
l1 = ModelEvaluation(model, r'F:\Data\CodeData\YoloV5\data\labels\train', 'yolov5_t', ['AJ', 'BX', 'CJ', 'CK', 'CQ', 'CR', 'FS', 'FZ', 'JG_D', 'PL', 'QF', 'SG',
                                                                        'SL', 'TL', 'ZW', 'JG_U', 'PL_L'], 0.1)
# l1 = ModelEvaluation(model, r'D:\Desktop\Data1027\Data_sp\train', 'yolov5_l', ['AJ', 'BX', 'CJ', 'CK', 'CQ', 'CR', 'FS', 'FZ', 'QF', 'SG',
#                                                                         'SL', 'ZW', 'JG_U', 'PL_L'], 0.1)
